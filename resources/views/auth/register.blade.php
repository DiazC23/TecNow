            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4" id="registerForm">
                ...
                <div class="flex flex-col items-center mb-2">
                    <div class="relative">
                        ...
                        <button type="button" onclick="document.getElementById('avatarModal').classList.remove('hidden')"
                ...
                <div>
                    ...
                    <div class="relative">
                        <svg class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Tu nombre completo"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="tucorreo@lagos.tecmm.edu.mx"
                            class="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none text-gray-900" />
                    </div>
                </div>
...
<div id="avatarModal" class="hidden fixed inset-0 z-50 flex items-center justify-center px-4">
    <div class="absolute inset-0 bg-black/60" onclick="document.getElementById('avatarModal').classList.add('hidden')"></div>
    <div class="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm z-10">
        <div class="flex items-center justify-between mb-4">
            ...
            <button type="button" onclick="document.getElementById('avatarModal').classList.add('hidden')" class="text-gray-400 hover:text-gray-600">
